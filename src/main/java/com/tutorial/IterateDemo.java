...
public class IterateDemo {
    public static void main(String[] args) throws Exception {
        ...
        notEqualtoten.writeAsText("/Users/ekwong/Downloads/flink_sandbox/iterate/notten").setParallelism(1);
        equaltoten.writeAsText("/Users/ekwong/Downloads/flink_sandbox/iterate/ten").setParallelism(1);
