...
public class AverageProfit {
    public static void main(String[] args) throws Exception{
        ...
        DataStream < String > data = env.readTextFile("/Users/ekwong/Downloads/flink_sandbox/reduce_operator/avg");
        ...
        profitPerMonth.writeAsText("/Users/ekwong/Downloads/flink_sandbox/reduce_operator/profit_per_month.txt").setParallelism(1);
