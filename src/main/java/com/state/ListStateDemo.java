...
public class ListStateDemo {
    public static void main(String[] args) throws Exception {
        ...
        String dir = "/Users/ekwong/Downloads/flink_sandbox/state/output/";
        ...
        DataStream < Tuple2 < String, Long >> sum = data.map(new MapFunction < String, Tuple2 < Long, String >> () {
            ...
            sum.writeAsText(dir + "liststate").setParallelism(1);
//        sum.addSink(StreamingFileSink
//                .forRowFormat(new Path(dir + "liststate"), new SimpleStringEncoder < Tuple2 < String, Long >> ("UTF-8"))
